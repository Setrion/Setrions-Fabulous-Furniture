    ...
    public KitchenCounterBlockEntity(BlockPos blockPos, BlockState blockState) {
        ...
        this.openersCounter = new ContainerOpenersCounter() {
            protected void onOpen(Level level, BlockPos pos, BlockState state) {
                if (state.getBlock() instanceof KitchenCounterContainerDoorBlock || state.getBlock() instanceof KitchenCounterContainerDrawerBlock || state.getBlock() instanceof KitchenCabinetContainerBlock || state.getBlock() instanceof KitchenCabinetContainerDoorBlock || state.getBlock() instanceof KitchenCabinetContainerSidewaysDoorBlock) {
