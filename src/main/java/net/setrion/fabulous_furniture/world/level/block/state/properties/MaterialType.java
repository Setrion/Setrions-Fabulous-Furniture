...
public record MaterialType(String name, Item item) {
    ...
    public static final MaterialType COBBLESTONE;
    public static final MaterialType COBBLED_DEEPSLATE;
    ...
    public static final MaterialType POLISHED_GRANITE;
    public static final MaterialType POLISHED_DIORITE;
    public static final MaterialType POLISHED_ANDESITE;
    ...
    static {
        ...
        COBBLESTONE = register(new MaterialType("cobblestone", Blocks.COBBLESTONE.asItem()));
        COBBLED_DEEPSLATE = register(new MaterialType("cobbled_deepslate", Blocks.COBBLED_DEEPSLATE.asItem()));
        GRANITE = register(new MaterialType("granite", Blocks.GRANITE.asItem()));
        DIORITE = register(new MaterialType("diorite", Blocks.DIORITE.asItem()));
        ANDESITE = register(new MaterialType("andesite", Blocks.ANDESITE.asItem()));
        POLISHED_GRANITE = register(new MaterialType("polished_granite", Blocks.POLISHED_GRANITE.asItem()));
        POLISHED_DIORITE = register(new MaterialType("polished_diorite", Blocks.POLISHED_DIORITE.asItem()));
        POLISHED_ANDESITE = register(new MaterialType("polished_andesite", Blocks.POLISHED_ANDESITE.asItem()));
